...
export const workData:workDatum[] = [
  ...
  },
  {
    ...
    detail: `公式パンフレットなどを制作する印刷物担当と、案内サインを制作する案内制作担当を兼任しました。この回のロゴやテーマには一切かかわっておらず、あくまでそのおもしろい展開を考えてデザインするという立場で参加しています。
      ...
      デザインするさいにいつも心に留めている「わくわくさせるクリエイティブ」ということばは、この五月祭で出会った先輩委員から学んだ姿勢です。制作スケジュールが厳しくなることが多く、クリエイターとしてのこだわりを通しきれなかった場面もあり、「わくわくさせる」というフレーズはそんな悔しさを思い出させてくれるような特別な存在です。`,
    objectPosition: 80,
    works: [
      {
        name: '公式パンフレット 表紙',
